 <ol>
    ...
    <li>Melakukan pembayaran biaya pendaftaran sebesar Rp800.000 pada rekening XXXX-XXXX (meliputi seragam anak tiga setel) dan melampirkan bukti pembayaran, dengan ketentuan:
        <ul>
            ...
            <li>Pembayaran diatas 75% dapat langsung mengambil baju</li>
        </ul>
    </li><br>
    <li>Melengkapi Formulir Pendaftaran;</li><br>
    <li>Melampirkan Dokumen Persyaratan (Scan/Foto dengan gambar tampak jernih dan tulisan kelihatan jelas, ukuran maksimal dokumen 5MB harap memeriksa ukuran dokumen sebelum Anda mengunggah ke sistem) sebagai berikut:
        <ul>

<nav {{ $attributes->merge(['class'=>"app-navbar-mobile flex flex-col content-padding"])}}>
    <div class="flex flex-center margin-vertical content-padding content-padding-side-rem">
        ...
        @auth<h4 class="content-padding-side-rem">Menu {{ Auth::user()->role_id == 1 ? 'Admin' : 'Pendaftar' }}</h4>@endauth
    </div>
    <hr class="content-margin" style="border: 1px solid rgba(255, 255, 255, .15);">
    <ul class="content-padding-side-rem">
    @if (Auth::user()->role_id == 1)
            <li>
                <x-nav-link class="content-padding-vertical" href="/admin/dashboard" :active="request()->is('admin/dashboard')">
                    <div class="flex justify-between content-padding-side-rem">
                        ...
                        <span class="padding-left-10">Beranda</span>
                    </div>
                </x-nav-link>
            </li>
            <li>
                <x-nav-link class="content-padding-vertical" href="/admin/ppdb" :active="request()->is('admin/ppdb*')">
                    <div class="flex justify-between content-padding-side-rem">
                        ...
                        <span class="padding-left-10">PPDB</span>
                    </div>
                </x-nav-link>
            </li>
            <li>
                <x-nav-link class="content-padding-vertical" href="/admin/pengumuman" :active="request()->is('admin/pengumuman*')">
                    <div class="flex justify-between content-padding-side-rem">
                        ...
                        <span class="padding-left-10">Pengumuman</span>
                    </div>
                </x-nav-link>
            </li>
        @else
            <li>
                <x-nav-link class="content-padding-vertical" href="/pendaftar/dashboard" :active="request()->is('pendaftar/dashboard')">
                    <div class="flex justify-between content-padding-side-rem">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height="20" width="20"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/></svg>
                        <span class="padding-left-10">Beranda</span>
                    </div>
            ...
            <li>
                ...
                @endphp
                <div class="submenu content-padding-side-rem">
                    <button data-toggle-target="#appNavMobileSub" class="conform flex justify-between content-padding-vertical {{ $submenuOpen ? 'current active' : '' }} ">
            ...
            <li>
                <x-nav-link class="content-padding-vertical" href="/pendaftar/profil" :active="request()->is('pendaftar/profil')">
                    <div class="flex justify-between content-padding-side-rem">
                        ...
                        <span class="padding-left-10">Profil</span>
                    </div>
                </x-nav-link>
            </li>
        @endif
        {{-- <li>
            <form action="/logout" method="POST">
                @csrf
                <button type="submit" class="conform content-padding-vertical">
                    <div class="flex justify-between content-padding-side-rem">
                        ...
                        <span class="padding-left-10">Keluar</span>
                    </div>
                </button>
            </form>
        </li> --}}

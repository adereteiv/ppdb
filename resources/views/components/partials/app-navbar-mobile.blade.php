<nav {{ $attributes->merge(['class'=>"app-navbar-mobile flex flex-col content-padding"])}}>
    ...
    <ul class="content-padding-side-rem">
        @if (Auth::user()->role_id == 1)
            <li>
                <x-nav-link class="content-padding-vertical" href="{{ route('admin.dashboard') }}" :active="request()->is('admin/dashboard')">
            ...
            <li>
                <x-nav-link class="content-padding-vertical" href="{{ route('admin.ppdb.index') }}" :active="request()->is('admin/ppdb*')">
                    <div class="flex justify-between content-padding-side-rem">
            ...
            <li>
                <x-nav-link class="content-padding-vertical" href="{{ route('admin.pengumuman.index') }}" :active="request()->is('admin/pengumuman*')">
                    <div class="flex justify-between content-padding-side-rem">
        ...
        @else
            @if (request()->is('pendaftar/recovery'))
                <li>
                    <x-nav-link class="content-padding-vertical" href="/pendaftar/dashboard" :active="request()->is('pendaftar/recovery')">
                        <div class="flex justify-between content-padding-side-rem">
            ...
            @else
                ...
                <li>
                    <x-nav-link class="content-padding-vertical" href="{{ route('pendaftar.profil') }}" :active="request()->is('pendaftar/profil')">
                        <div class="flex justify-between content-padding-side-rem">

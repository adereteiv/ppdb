<aside {{ $attributes->merge(['class'=>"app-navbar"])}}>
    <div class="content-padding">
        <div class="app-topbar flex flex-center ">
            <div class="sidebar-top">
                <span class="flex flex-center">
                    <svg class="sidebar-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height="24" width="24"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg>
                    <h3 class="sidebar-1">PPDB Daring</h3>
                </span>
            </div>
        </div>
    </div>
    ...
    <nav class="scrollable">
        <ul>
            @if (Auth::user()->role_id == 1)
                <li>
                    <x-nav-link class="content-padding-vertical content-padding-side-rem" href="/admin/dashboard" :active="request()->is('admin/dashboard')">
                ...
                <li>
                    <x-nav-link class="content-padding-vertical content-padding-side-rem" href="/admin/ppdb" :active="request()->is('admin/ppdb*')">
                ...
                <li>
                    <x-nav-link class="content-padding-vertical content-padding-side-rem" href="/admin/pengumuman" :active="request()->is('admin/pengumuman*')">
            ...
            @else
                <li>
                    <x-nav-link class="content-padding-vertical content-padding-side-rem" href="/pendaftar/dashboard" :active="request()->is('pendaftar/dashboard')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height="20" width="20"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/></svg>
                        <span class="flex flex-center padding-left-10">Beranda</span>
                    </x-nav-link>
                </li>
                <li>
                    ...
                    {{-- <ul x-show="open" class="submenu">
                        <li>
                            <x-nav-link class="content-padding-vertical content-padding-side-rem" href="/pendaftar/formulir" :active="request()->is('pendaftar/formulir')">Formulir</x-nav-link>
                        </li>
                        <li>
                            <x-nav-link class="content-padding-vertical content-padding-side-rem" href="/pendaftar/dokumen" :active="request()->is('pendaftar/dokumen')">Unggah Dokumen</x-nav-link>
                        </li>
                        <li>
                            if (['/pendaftar/formulir', '/pendaftar/dokumen', '/pendaftar/buktibayar'].includes(window.location.pathname)) {
                            <x-nav-link class="content-padding-vertical content-padding-side-rem" href="/pendaftar/buktibayar" :active="request()->is('pendaftar/buktibayar')">Bukti Pembayaran</x-nav-link>
                        </li>
                    </ul> --}}
                        <div id="appNavSub" class="submenu-content {{ $submenuOpen ? 'open' : '' }}">
                            <div class="content-padding-bottom-rem content-padding-side-rem">
                                <div class="wrapper">
                                    <x-nav-link href="/pendaftar/formulir" :active="request()->is('pendaftar/formulir')">Formulir</x-nav-link>
                                    <x-nav-link href="/pendaftar/dokumen" :active="request()->is('pendaftar/dokumen')">Unggah Dokumen</x-nav-link>
                                    <x-nav-link href="/pendaftar/buktibayar" :active="request()->is('pendaftar/buktibayar')">Bukti Pembayaran</x-nav-link>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li>
                    <x-nav-link class="content-padding-vertical content-padding-side-rem" href="/pendaftar/profil" :active="request()->is('pendaftar/profil')">
        ...
        {{-- Moved to header --}}
            {{-- <li><form action="/logout" method="POST">
                @csrf
                <button type="submit" class="conform">
                    ...
                    <span class="flex flex-center padding-left-10">Keluar</span>
                </button>
            </form></li> --}}
        </ul>
    </nav>

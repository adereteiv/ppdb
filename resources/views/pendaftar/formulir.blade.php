        ...
        <div class="content-padding content-padding-side-rem">
            <div class="content-padding-side-rem">
                <x-flash-message flash='blue'>
                    Silakan isi data pada formulir berikut secara lengkap dan jelas sesuai kebenaran yang ada.
                    ...
                    <div class="flex-1 content-padding-side-rem">
                        <div class="flex flex-col">
                            <div>
                                ...
                                <table>
                                    <div class="flex">
                                        <tr><td>Nama<sup style="color:#FF0000;">*</sup><x-input type="text" name="nama_anak" class="form-item" :value="old('nama_anak', $infoAnak->nama_anak ?? '')" placeholder="Nama Anak" required/></td></tr>
                                        <tr><td>Nama Panggilan<sup style="color:#FF0000;">*</sup><x-input type="text" name="panggilan_anak" class="form-item" :value="old('panggilan_anak', $infoAnak->panggilan_anak ?? '')" placeholder="Nama Panggilan Anak" required/></td></tr>
                                        <tr><td>Tempat Lahir<sup style="color:#FF0000;">*</sup><x-input type="text" name="tempat_lahir" class="form-item" :value="old('tempat_lahir', $infoAnak->tempat_lahir ?? '')" placeholder="Tempat Lahir Anak" required/></td></tr>
                                        <tr><td>Tanggal Lahir<sup style="color:#FF0000;">*</sup><x-input type="date" name="tanggal_lahir" class="form-item" :value="old('tanggal_lahir', $infoAnak->tanggal_lahir ?? '')" required/></td></tr>
                                        <tr><td>Alamat<sup style="color:#FF0000;">*</sup><x-input-textarea type="text" name="alamat_anak" rows="3" cols="23" :value="old('alamat_anak', $infoAnak->alamat_anak ?? '')" placeholder="Silakan tulis alamat disini" required/></td></tr>
                                        <tr><td>Jenis Kelamin<sup style="color:#FF0000;">*</sup><x-input-radio id="jk" name="jenis_kelamin" :options="config('form-options.jenis_kelamin')" :value="$infoAnak->jenis_kelamin ?? '' " required/></td></tr>
                                        <tr><td>Kewarganegaraan<sup style="color:#FF0000;">*</sup><x-input-radio id="kwn" name="kewarganegaraan" :options="config('form-options.kewarganegaraan')" :value="$infoAnak->kewarganegaraan ?? '' " required/></td></tr>
                                        <tr><td>Bahasa di Rumah<sup style="color:#FF0000;">*</sup><x-input-select name="bahasa_di_rumah" class="form-item" :options="config('form-options.bahasa_di_rumah')" :value="$infoAnak->bahasa_di_rumah ?? '' " required/></td></tr>
                                        <tr><td>Agama<sup style="color:#FF0000;">*</sup><x-input-select name="agama" class="form-item" :options="config('form-options.agama')" :value="$infoAnak->agama ?? '' " required/></td></tr>
                                        <tr><td>Status Tinggal<sup style="color:#FF0000;">*</sup><x-input-select name="status_tinggal" class="form-item" :options="config('form-options.status_tinggal')" :value="$infoAnak->status_tinggal ?? '' " required/></td></tr>
                                        <tr><td>Yang Mendaftarkan<sup style="color:#FF0000;">*</sup><x-input-radio id="yang_mendaftarkan" name="yang_mendaftarkan" :options="config('form-options.yang_mendaftarkan')" :value="$infoAnak->yang_mendaftarkan ?? '' " required/></td></tr>
                                        <tr><td>Status Anak (dari yang mendaftarkan)<sup style="color:#FF0000;">*</sup><x-input-select name="status_anak" :options="config('form-options.status_anak')" :value="$infoAnak->status_anak ?? '' " required class="form-item"/></td></tr>
                                        <tr><td>Anak Ke-<sup style="color:#FF0000;">*</sup><x-input type="number" name="anak_ke" class="form-item" min="1" :value="old('anak_ke', $infoAnak->anak_ke ?? '')" required/></td></tr>
                                        ...
                                        <tr><td>Berat Badan (kg)<sup style="color:#FF0000;">*</sup><x-input type="number" name="berat_badan" class="form-item" :value="old('berat_badan', $infoAnak->berat_badan ?? '')" required/></td></tr>
                                        <tr><td>Tinggi Badan (cm)<sup style="color:#FF0000;">*</sup><x-input type="number" name="tinggi_badan" class="form-item" :value="old('tinggi_badan', $infoAnak->tinggi_badan ?? '')" required/></td></tr>
                                        <tr><td>Golongan Darah<sup style="color:#FF0000;">*</sup><x-input-select name="golongan_darah" class="form-item" :options="config('form-options.golongan_darah')" :value="$infoAnak->golongan_darah ?? '' " required/></td></tr>
                                        ...
                                        <tr><td>Mendaftar Sebagai<sup style="color:#FF0000;">*</sup><x-input-radio id="mendaftar_sebagai" name="mendaftar_sebagai" :options="config('form-options.mendaftar_sebagai')" :value="$infoAnak->mendaftar_sebagai ?? '' " required/></td></tr>
                        ...
                        <div class="flex flex-col gap-rem">
                            <div id="dataAyah">
                                ...
                                <table>
                                    ...
                                    <tr><td><label for="nomor_hp_ayah">Nomor HP</label><x-input type="tel" id="nomor_hp_ayah" name="nomor_hp_ayah" class="form-item ayah-input" :value="old('nomor_hp_ayah',$ayah->nomor_hp ?? '' )"/></td></tr>
                                </table>
                            </div>
                            <div id="dataIbu">
                                <h6>Data Ibu</h6>
                                <table>
                                    ...
                                    <tr><td><label for="nomor_hp_ibu">Nomor HP</label><x-input id="nomor_hp_ibu" type="tel" name="nomor_hp_ibu" class="form-item ibu-input" :value="old('nomor_hp_ibu',$ibu->nomor_hp ?? '' )"/></td></tr>
                                </table>
                            </div>
                            <div id="dataWali">
                                <h6>Data Wali</h6>
                                <table>
                                    ...
                                    <tr><td><label for="nomor_hp_wali">Nomor HP</label><x-input id="nomor_hp_wali" class="form-item wali-input" type="tel" name="nomor_hp_wali" :value="old('nomor_hp_wali',$wali->nomor_hp ?? '' )"/></td></tr>
                                </table>
                            </div>
                        </div>
                    </div>

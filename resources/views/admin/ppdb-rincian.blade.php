        ...
        <div class="ppdb-rincian content-padding-vertical content-padding-side-rem">
            <div class="flex justify-flex-end">
                <x-dropdown class="wrapper right-0">
                    ...
                    <form action="{{ route('admin.ppdb.arsip.destroy', $batch->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus gelombang ini? (Tindakan tidak dapat diurung!)')"> @csrf  @method('DELETE')
                        <button type="submit" class="dropdown-menu tombol-none margin-unset">

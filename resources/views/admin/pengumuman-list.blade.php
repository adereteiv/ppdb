@forelse($data as $entry)
    <tr>
        ...
        <td>
            <p><strong>[{{ $entry->tipe_pengumuman }}] {{ $entry->judul }}</strong></p>
        ...
        <td>
            <div class="flex justify-center">
                ...
                <form action="{{ route('admin.pengumuman.destroy', $entry->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus pengumuman ini?')"> @csrf @method('DELETE')

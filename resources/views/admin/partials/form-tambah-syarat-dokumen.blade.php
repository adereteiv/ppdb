<form id="tambahSyaratDokumenForm" method="POST" action="{{ route('admin.ppdb.buat.syarat_dokumen.store') }}">@csrf
    <div class="content-padding-rem">
        ...
        <div class="flex justify-center margin-vertical padding-10">

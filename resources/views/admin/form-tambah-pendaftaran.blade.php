        ...
        <div class="content-padding-side-rem content-padding-bottom-rem">
            <div class="constrict">
                <x-flash-message flash='blue' button>
                    Untuk menambahkan rekam pendaftaran secara manual, silakan mengisi data dengan lengkap.
                </x-flash-message>
                                ...
                                <div class="padding-10">
                                    ...
                                    <table>
                                        ...
                                        <tr><td>Nomor HP/WA<sup style="color:#FF0000;">*</sup></td>
                                            <td><x-input type="tel" name="nomor_hp" placeholder="Nomor HP yang bisa dihubungi" required/>
                                        </td></tr>
                                ...
                                <div class="padding-10">
                                    ...
                                    <table>
                                        ...
                                        <tr><td>Jenis Kelamin</td>
                                            <td><x-input-radio id="jenis_kelamin" name="jenis_kelamin" :options="config('form-options.jenis_kelamin')" required/></td></tr>
                                        <tr><td>Kewarganegaraan</td>
                                            <td><x-input-radio id="kewarganegaraan" name="kewarganegaraan" :options="config('form-options.kewarganegaraan')" required/></td></tr>
                                        ...
                                        <tr><td>Yang Mendaftarkan</td>
                                            <td><x-input-radio id="yang_mendaftarkan" name="yang_mendaftarkan" :options="config('form-options.yang_mendaftarkan')" required/></td></tr>
                                        ...
                                        <tr><td>Mendaftar Sebagai</td>
                                            <td><x-input-radio id="mendaftar_sebagai" name="mendaftar_sebagai" :options="config('form-options.mendaftar_sebagai')" required/></td></tr>
                                ...
                                <div class="padding-10" id="dataAyah">
                                    ...
                                    <table>
                                        <tr><td width="180px"><label for="nama_ayah">Nama</label></td>
                                            <td><x-input id="nama_ayah" type="text" name="nama_ayah" class="ayah-input" required/></tr>

    ...
    <tr>
        ...
        <td>
            <div class="flex justify-center">
                ...
                <a href="{{ route('admin.ppdb.aktif.edit', $entry->id) }}" class="tombol tombol-netral tooltip" tooltip="top">
                ...
                <form action="{{ route('admin.ppdb.aktif.destroy', $entry->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?')"> @csrf @method('DELETE')

    ...
    <div class="wrapper">
        ...
        <x-table-list class="ppdb-list-table">
            <x-slot:menu>
                ...
                @if ($batch->status)
                    <!-- create -->
                    <a href="{{ route('admin.ppdb.aktif.create') }}" class="tombol tombol-netral tooltip" tooltip="left">
                        ...
                        <span>Tambah</span>
                        <div class="tooltiptext">Tambah Pendaftaran Manual</div>
                    </a>
                @endif
                </div>
            </x-slot:menu>
